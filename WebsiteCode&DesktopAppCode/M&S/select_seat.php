...
if(isset($_GET['cinemaloc']) && isset($_GET['cinemanam']) && isset($_GET['roomnb']) && isset($_GET['shownb']) && isset($_GET['start_time']) && isset($_GET['end_time'])) {
    // Retrieve each parameter from the URL and save them in session variables
    $_SESSION['cinemaloc'] = $_GET['cinemaloc'];
    $_SESSION['cinemanam'] = $_GET['cinemanam'];
    $_SESSION['roomnb'] = $_GET['roomnb'];
    $_SESSION['shownb'] = $_GET['shownb'];

	$_SESSION['movie'] = $_GET['movie'];

    $_SESSION['start_time'] = urldecode($_GET['start_time']); // Decode URL encoded time
    $_SESSION['end_time'] = urldecode($_GET['end_time']); // Decode URL encoded time

    // Include the checkSeat.php file
    ...
    <div class="container" style="margin-top: 170px;">
        ...
        <div class="col-4">
                    ...
                    <div class="text-center" style="color: white;">
                       ...
                       <input class="btn btn-success" id="submitBtn" type="submit" name="submit" style="margin:10px;" disabled>
...
<script>
    ...
    // Call the function when any checkbox is changed
    var checkboxes = document.querySelectorAll('input[type="checkbox"]');
    checkboxes.forEach(function(checkbox) {
